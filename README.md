...
IntArrayList > when you need to save memory and there are not many iterations of increasing the length
IntVector > when the increase expected is big and you want to reduce iterations
