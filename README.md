...
### com.BigDecimalOperations.Car Inventory System
...
2. Create an abstract class named `com.BigDecimalOperations.Car` and define the following properties and behaviors:
...
3. Create three classes that extend `com.BigDecimalOperations.Car`: `com.InventoryCarSystem.Sedan`, `com.InventoryCarSystem.UtilityVehicle` and `com.InventoryCarSystem.Truck`.
