...
An example where IntArrayList is more efficient: When adding at a list at a sporadic rate, and saving on memory usage
An example where IntVector is more efficient: When adding at a constant or exponential speed, therefore allocating more memory is compensating by having to copy the array less times and gaining speed
